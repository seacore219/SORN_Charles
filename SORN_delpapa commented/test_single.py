...
import utils
# This assumes that you are in the folder "common"          more imports
...
# Start debugging mode when an error is raised              error handling
...
# Parameters are read from the second command line argument             loads settings based on which param and experiment file is loaded
...
# Create a StatsCollection and fill it with methods for all statistics      SORN matrices built at Sorn(c, source)
